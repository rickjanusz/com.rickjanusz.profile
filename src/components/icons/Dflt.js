...
export default function Dflt() {
  return (
    <IconStyles viewBox="0 0 66 82.5">
      <g>
        <path
          d="M8.2,40h7.5c0.1,0,0.3-0.1,0.5-0.1c1.5-4.3,5.5-7.2,10.1-7.2c0.2,0,0.7,0,0.8,0c1.6-5.1,6.5-8.7,12.2-8.7
        ...
        />
        <path
          d="M57.3,41.7c-0.4-2-1.5-3.8-3-5c-1.3-1.1-2.9-1.8-4.8-2c-0.8-5-5.1-8.7-10.3-8.7c-5.3,0-9.9,3.7-10.6,8.8
