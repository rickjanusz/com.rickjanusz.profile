      ...
      <IconStyles>
        <svg viewBox="0 0 64 80">
          <g>
            <path
              className="st0"
              d="M3,62h16c0.6,0,1-0.4,1-1v-6c0-0.6-0.4-1-1-1H3c-0.6,0-1,0.4-1,1v6C2,61.6,2.4,62,3,62z M4,56h14v4H4V56z"
            />
            <path
              className="st0"
              d="M3,35h1v3.8C4,40,5,41,6.2,41c0.8,0,1.6-0.5,2-1.2L8.6,39H15c2.8,0,5-2.2,5-5v-2h8v7c0,0.6,0.4,1,1,1h4.8
		...
		l-5-0.8V26z M4,30.2L8.8,31c0.1,0,0.2,0,0.3,0l4.8-0.8V33H4V30.2z"
            ...
            <path
              className="st0"
              d="M61.4,7.9c0.5-0.2,0.7-0.8,0.4-1.3c-0.1-0.2-0.3-0.4-0.4-0.4l-8-4c-0.5-0.2-1.1,0-1.3,0.4C52,2.7,52,2.8,52,3v27h-7
		...
		H46v-4h14V60z M60,54H46v-4h14V54z M60,48H46v-4h14V48z M60,42H46v-4h14V42z M60,32v4H46v-4H60z"
            ...
            <path
              className="st0"
              d="M24,42c-0.6,0-1,0.4-1,1v18c0,0.6,0.4,1,1,1h16c0.6,0,1-0.4,1-1V43c0-0.6-0.4-1-1-1H24z M39,60H25v-4h14V60z M39,54H25v-4
